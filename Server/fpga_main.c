...
//   }
    ...
    //////////////////////////////////////////////////////////
		...
		if(ser){
			...
			perror("Failed to open UART");  // Prints the string you give it, then a colon, then a textual representation of the current errno value
			return -1;  // Or however you want to handle this error
		}
